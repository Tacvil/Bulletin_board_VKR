...
import com.example.bulletin_board.pix.models.Flash
...
class CameraXManager(
    ...
    fun stopCamera() {
        ...
        // Остановка видеозахвата, если используется
//        videoCapture?.let {
//            it.stopRecording()
//        }

        // Очистка списка использованных случаев
        useCases.clear()

        // Дополнительные действия по освобождению ресурсов
        // ...
